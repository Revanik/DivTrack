...
# app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///dividend_tracker.db')

database_url = os.environ.get('DATABASE_URL', 'sqlite:///dividend_tracker.db')
